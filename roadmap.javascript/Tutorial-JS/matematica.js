...
/*
    ...
    Math.chão(x)	Retorna x arredondado para baixo para o inteiro mais próximo
    ...
    Se você quiser usar graus em vez de radianos, precisará converter graus em radianos:
